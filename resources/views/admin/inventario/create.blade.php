                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="area" 
                               ...
                               value="{{ old('area') }}" placeholder="Ej: Zona Norte, Planta 1, etc.">
                        @error('area')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre_recibe" 
                               ...
                               value="{{ old('nombre_recibe') }}" required>
                        @error('nombre_recibe')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="clave_empleado" 
                               ...
                               value="{{ old('clave_empleado') }}" required>
                    ...
                    <div id="campos-equipo" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="numero_serie" 
                                   ...
                                   value="{{ old('numero_serie') }}" placeholder="Ej: SN-2024-001">
                            @error('numero_serie')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <textarea name="datos_extra" class="form-control @error('datos_extra') is-invalid @enderror" 
                                      rows="2" placeholder="Información adicional...">{{ old('datos_extra') }}</textarea>
                            @error('datos_extra')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div id="campos-producto" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-8">
                            ...
                            <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" 
                                      rows="2" placeholder="Descripción del producto...">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
