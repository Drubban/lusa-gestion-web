...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.tecnologias.store') }}" id="tecnologiaForm">
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" 
                               ...
                               value="{{ old('nombre') }}" placeholder="Nombre descriptivo">
                        @error('nombre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div id="campos-barras" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="id_barra" class="form-control" value="{{ old('id_barra') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Barras</label>
                            <input type="text" name="barras" class="form-control" value="{{ old('barras') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Teléfono</label>
                            <input type="text" name="telefono_barras" class="form-control" value="{{ old('telefono_barras') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Plan</label>
                            <input type="text" name="plan_barras" class="form-control" value="{{ old('plan_barras') }}">
                        </div>
                    </div>
                    ...
                    <div id="campos-telpo" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="imei_antes" class="form-control" value="{{ old('imei_antes') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">V. APK</label>
                            <input type="text" name="v_apk" class="form-control" value="{{ old('v_apk') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Telpo</label>
                            <input type="text" name="telpo" class="form-control" value="{{ old('telpo') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">IMEI Telpo</label>
                            <input type="text" name="imei_telpo" class="form-control" value="{{ old('imei_telpo') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Teléfono</label>
                            <input type="text" name="telefono_telpo" class="form-control" value="{{ old('telefono_telpo') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Plan</label>
                            <input type="text" name="plan_telpo" class="form-control" value="{{ old('plan_telpo') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Costo del Plan</label>
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" step="0.01" name="costo_plan" class="form-control" value="{{ old('costo_plan') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="campos-gps" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="imei_gps" class="form-control" value="{{ old('imei_gps') }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Teléfono</label>
                            <input type="text" name="telefono_gps" class="form-control" value="{{ old('telefono_gps') }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Plan</label>
                            <input type="text" name="plan_gps" class="form-control" value="{{ old('plan_gps') }}">
                        </div>
                    </div>
                    ...
                    <div id="campos-mdvr" class="row g-3" style="display: none;">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="dvr" class="form-control" value="{{ old('dvr') }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="camaras" class="form-control" value="{{ old('camaras') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Memoria</label>
                            <input type="text" name="memoria" class="form-control" value="{{ old('memoria') }}">
                        </div>
                    </div>
