            ...
            <form method="POST" action="{{ route('admin.operadores.store') }}">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="clave_operador" class="form-control @error('clave_operador') is-invalid @enderror" maxlength="5" pattern="\d{5}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="unidad_id" class="form-select">
                            ...
                            <option value="{{ $unidad->id }}">{{ $unidad->numero_economico }} - {{ $unidad->nombre_unidad }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
