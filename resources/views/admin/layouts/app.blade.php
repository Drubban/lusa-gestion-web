            ...
            <nav class="col-md-2 d-none d-md-block bg-dark sidebar" style="min-height: 100vh;">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <!-- Unidades -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.unidades.index') }}">
                        ...
                        <!-- Operadores -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.operadores.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.documentos-capacitacion.index') }}">
                        ...
                        <!-- Movimientos -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.movimientos.index') }}">
                        ...
                        <!-- QR -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.qr.exportar') }}">
                        ...
                        <!-- Importar -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.importar.index') }}">
                        ...
                        <!-- Ajustes -->
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.ajustes.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.tecnologias.index', ['tipo' => 'barras']) }}">
                                <i class="fas fa-barcode"></i> Tecnología Barras
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.tecnologias.index', ['tipo' => 'telpo']) }}">
                                <i class="fas fa-mobile-alt"></i> Tecnología Telpo
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.tecnologias.index', ['tipo' => 'gps']) }}">
                                <i class="fas fa-satellite"></i> Tecnología GPS
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('admin.tecnologias.index', ['tipo' => 'mdvr']) }}">
