...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        ...
        <a href="<?php echo e(route('admin.agendamientos.create')); ?>" class="btn btn-primary rounded-pill px-4">
            ...
            <form method="GET" class="row g-3 align-items-end">
                    ...
                    <select name="unidad_id" class="form-select">
                        ...
                        <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($unidad->id); ?>" <?php echo e(request('unidad_id') == $unidad->id ? 'selected' : ''); ?>>
                                <?php echo e($unidad->numero_economico); ?>
                ...
                <div class="col-md-2">
                    ...
                    <select name="estado" class="form-select">
                        ...
                        <option value="reagendado" <?php echo e(request('estado') == 'reagendado' ? 'selected' : ''); ?>>Reagendado</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.agendamientos.index')); ?>" class="btn btn-secondary rounded-pill px-4">
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $agendamientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                            ...
                            <td><?php echo e($item->fecha_agendada->format('d/m/Y')); ?></td>
                            <td><?php echo $item->estado_badge; ?></td>
                            <td>
                                <?php if($item->estado == 'pendiente'): ?>
                                    ...
                                    ?>
                                    <?php if($dias > 7): ?>
                                        <span class="text-success"><?php echo e($dias); ?> días</span>
                                    <?php elseif($dias >= 0): ?>
                                        <span class="text-warning"><?php echo e($dias); ?> días</span>
                                    <?php else: ?>
                                        <span class="text-danger"><?php echo e(abs($dias)); ?> días vencido</span>
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('admin.agendamientos.edit', $item)); ?>" 
                                       class="btn btn-sm btn-outline-warning" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if($item->estado == 'pendiente'): ?>
                                        <a href="<?php echo e(route('admin.agendamientos.marcar-cumplido', $item)); ?>" 
                                        ...
                                        <button type="button" 
                                                ...
                                                data-unidad="<?php echo e($item->unidad->numero_economico); ?>"
                                                data-fecha="<?php echo e($item->fecha_agendada->format('Y-m-d')); ?>">
                                            <i class="fas fa-calendar-plus"></i>
                                        </button>
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('admin.agendamientos.destroy', $item)); ?>" 
        ...
        <div class="card-footer bg-white">
            <?php echo e($agendamientos->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hulis\lusa-gestion-web\resources\views/admin/agendamientos/index.blade.php ENDPATH**/ ?>