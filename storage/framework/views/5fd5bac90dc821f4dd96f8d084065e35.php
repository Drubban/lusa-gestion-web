                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" name="equipo_telpo" 
                                           ...
                                           value="1" <?php echo e(old('equipo_telpo', $unidad->equipo_telpo) ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" name="equipo_gps" 
                                           ...
                                           value="1" <?php echo e(old('equipo_gps', $unidad->equipo_gps) ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" name="equipo_barras" 
                                           ...
                                           value="1" <?php echo e(old('equipo_barras', $unidad->equipo_barras) ? 'checked' : ''); ?>>
