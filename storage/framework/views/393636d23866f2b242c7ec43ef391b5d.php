...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            <form method="POST" action="<?php echo e(route('admin.inventario.update', $inventario->id)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('fecha_entrega', $inventario->fecha_entrega->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($depto->id); ?>" <?php echo e(old('departamento_id', $inventario->departamento_id) == $depto->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('area', $inventario->area)); ?>" placeholder="Ej: Zona Norte, Planta 1, etc.">
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('nombre_recibe', $inventario->nombre_recibe)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('clave_empleado', $inventario->clave_empleado)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('categoria', $inventario->categoria) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($nombre); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('nombre_equipo', $inventario->nombre_equipo)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('marca', $inventario->marca)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('modelo', $inventario->modelo)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('numero_serie', $inventario->numero_serie)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="2"><?php echo e(old('datos_extra', $inventario->datos_extra)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('nombre_producto', $inventario->nombre_producto)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('marca_producto', $inventario->marca_producto)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('cantidad', $inventario->cantidad ?? 1)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="2"><?php echo e(old('descripcion', $inventario->descripcion)); ?></textarea>
                            ...
                            <div class="col-md-12">
                                <?php if($inventario->imagen): ?>
                                    <div class="mb-2">
                                        ...
                                        <div>
                                            <a href="<?php echo e($inventario->imagen_url); ?>" target="_blank" class="btn btn-sm btn-info">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hulis\lusa-gestion-web\resources\views/admin/inventario/edit.blade.php ENDPATH**/ ?>