...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        ...
        <div>
            <span class="badge bg-success rounded-pill px-3 py-2">
                <i class="fas fa-sync-alt me-1"></i> <?php echo e(now()->format('d/m/Y H:i')); ?>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate pbi-delay-1">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalUnidades); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate pbi-delay-2">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalOperadores); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate pbi-delay-3">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalMantenimientos); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate pbi-delay-4">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalCapacitaciones); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalInventario); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card pbi-animate">
                <div class="pbi-card-body text-center">
                    ...
                    <div class="pbi-kpi-value"><?php echo e($totalAjustes); ?></div>
    ...
    <div class="row pbi-row">
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-success"><?php echo e($unidadesConMantenimientoReciente); ?></div>
                    <div class="pbi-kpi-label">Con Mantenimiento</div>
                    <div class="pbi-progress">
                        <div class="pbi-progress-bar" style="width: <?php echo e($porcentajeUnidadesConMantenimiento); ?>%; background: var(--pbi-success);"></div>
                    </div>
                    <small class="text-muted"><?php echo e($porcentajeUnidadesConMantenimiento); ?>%</small>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-danger"><?php echo e($unidadesSinMantenimiento); ?></div>
                    <div class="pbi-kpi-label">Sin Mantenimiento</div>
                    <div class="pbi-progress">
                        <div class="pbi-progress-bar" style="width: <?php echo e($porcentajeSinMantenimiento); ?>%; background: var(--pbi-danger);"></div>
                    </div>
                    <small class="text-muted"><?php echo e($porcentajeSinMantenimiento); ?>%</small>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-primary"><?php echo e($promedioDiasMantenimiento ?? 'N/A'); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-warning">$<?php echo e(number_format($montoTotalAjustes, 0)); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-info"><?php echo e($agendamientosPendientes); ?></div>
        ...
        <div class="col-xl-2 col-md-4 mb-3">
            <div class="pbi-card">
                <div class="pbi-card-body text-center">
                    <div class="pbi-kpi-value text-danger"><?php echo e($agendamientosVencidos); ?></div>
        ...
        <div class="col-xl-8">
            <div class="chart-container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-secondary rounded-pill">+<?php echo e(array_sum($fechas)); ?> total</span>
                </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="text-muted ms-1 small"><?php echo e($item->tipo_mantenimiento ?? 'Sin tipo'); ?></span>
                                </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="text-muted ms-1 small"><?php echo e($item->asignacion->unidad->numero_economico ?? ''); ?></span>
                                </div>
                                <small class="text-muted"><?php echo e($item->created_at->diffForHumans()); ?></small>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="pbi-badge pbi-badge-info ms-1"><?php echo e($item->nombre_categoria); ?></span>
                                </div>
                                <small class="text-muted"><?php echo e($item->created_at->diffForHumans()); ?></small>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="text-muted ms-1">$<?php echo e(number_format($item->monto_total, 2)); ?></span>
                                    <span class="pbi-badge <?php echo e($item->firmado ? 'pbi-badge-success' : 'pbi-badge-warning'); ?> ms-1">
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <div class="pbi-card">
                ...
                <div class="pbi-card-body p-0">
                    <div class="recent-list">
                        <ul class="list-group list-group-flush">
                            <?php $__empty_1 = true; $__currentLoopData = $ultimosMovimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="fw-bold"><?php echo e($item->departamento->nombre ?? 'N/A'); ?></span>
                                    <span class="pbi-badge <?php echo e($item->tipo == 'entrada' ? 'pbi-badge-success' : 'pbi-badge-danger'); ?> ms-1">
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <div class="pbi-card">
                ...
                <div class="pbi-card-body p-0">
                    <div class="recent-list">
                        <ul class="list-group list-group-flush">
                            <?php $__empty_1 = true; $__currentLoopData = $ultimosAgendamientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="fw-bold"><?php echo e($item->unidad->numero_economico ?? 'N/A'); ?></span>
                                    <span class="pbi-badge <?php echo e($item->estado == 'pendiente' ? 'pbi-badge-warning' : 'pbi-badge-success'); ?> ms-1">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const capMeses = <?php echo json_encode(array_column($capPorMes, 'mes'), 512) ?>;
        const totalCaps = <?php echo json_encode(array_column($capPorMes, 'total'), 512) ?>;
        ...
        const inventarioDeptoNombres = <?php echo json_encode(array_column($inventarioPorDepto, 'nombre'), 512) ?>;
        const inventarioDeptoTotales = <?php echo json_encode(array_column($inventarioPorDepto, 'total'), 512) ?>;

        const estadosMantenimientoLabels = <?php echo json_encode(array_keys($estadosMantenimiento), 15, 512) ?>;
        const estadosMantenimientoValues = <?php echo json_encode(array_values($estadosMantenimiento), 15, 512) ?>;

        const tendenciaMantenimientoLabels = <?php echo json_encode(array_column($tendenciaMantenimientos, 'semana'), 512) ?>;
        const tendenciaMantenimientoValues = <?php echo json_encode(array_column($tendenciaMantenimientos, 'total'), 512) ?>;
